package core_pkg;
    ...
    import decode_pkg::iq_output_t;
    import writeback_pkg::rob_instance_pkt_t;
    import instr_fetch_pkg::spec_exec_buffer_instance_pkt_t;
    import issue_pkg::pc_buff_instance_pkt_t;
    import issue_pkg::fetch_packet_t;
    ...
    export decode_pkg::iq_output_t;
    export writeback_pkg::rob_instance_pkt_t;
    export instr_fetch_pkg::spec_exec_buffer_instance_pkt_t;
    export issue_pkg::pc_buff_instance_pkt_t;
    export issue_pkg::fetch_packet_t;
